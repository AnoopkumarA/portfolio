...
function App() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Developed official website for the ASME at my college. It includes sections for upcoming events, projects, and ASME initiatives,with responsive design.',
      ...
      demoLink: 'https://asme.sjcetpalai.ac.in/', target:'_blank',
